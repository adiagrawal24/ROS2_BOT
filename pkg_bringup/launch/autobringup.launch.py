...
def generate_launch_description():
  pkg_share = launch_ros.substitutions.FindPackageShare(package='pkg_description').find('pkg_description')
  navigation_dir = os.path.join(get_package_share_directory('pkg_navigation'), 'launch')
  rviz_launch_dir=os.path.join(get_package_share_directory('pkg_description'), 'launch')
  gazebo_launch_dir=os.path.join(get_package_share_directory('pkg_gazebo'), 'launch')
  cartographer_launch_dir=os.path.join(get_package_share_directory('pkg_slam'), 'launch')
  prefix_address = get_package_share_directory('pkg_navigation') 
  default_model_path = os.path.join(pkg_share, 'models/urdf/rmp_ros2_bot.xacro')
  ...
  map_directory = os.path.join(get_package_share_directory(
        'pkg_bringup'), 'maps','small_room.yaml')
